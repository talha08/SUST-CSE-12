                                        ...
                                        <table class="table table-hover">
                                            ...
                                            @foreach($routines as $routine)
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a class="btn btn-info btn-xs btn-archive Editbtn" href="{!!route('routine.edit',$routine->id)!!}"  style="margin-right: 3px;">Edit</a></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>                                    
