                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                                ...
                                <div class=" form"> 
                                    ...
                                    {!! Form::open(array('route' => 'file.store', 'novalidate' => 'novalidate' , 'method' => 'post', 'class' => 'cmxform form-horizontal tasi-form')) !!}


                                    <div class="form-group">
                                        {!! Form::label('name', "file Name (required)", array('class' => 'control-label col-lg-2')) !!}
                                        <div class="col-lg-10">
                                            {!! Form::text('name', null, array('class' => 'form-control', 'placeholder' => 'Enter file Name', 'required' => 'required', 'aria-required' =>'true')) !!}
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        {!! Form::label('url', "file URL", array('class' => 'control-label col-lg-2')) !!}
                                        <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('description', "file Description", array('class' => 'control-label col-lg-2')) !!}
                                        <div class="col-lg-10">
                                            {!! Form::textarea('description',null,  array('class' => 'summernote form-control', 'placeholder' => 'Enter file Name', 'required' => '', 'aria-required' =>false)) !!}
                                        </div>
                                    </div>
